...
const Hero = () => {
  return (
    <div className=" max-w-full sm:max-w-2/3 md:max-w-1/2 mx-auto mb-12 md:mb-0 ">
      <p className="text-md sm:text-xl md:text-2xl text-center text-gray-600 font-inter mb-5 md:mb-0 ">
