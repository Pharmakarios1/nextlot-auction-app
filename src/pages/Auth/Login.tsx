  ...
  return (
    <div className="max-w-sm mx-auto mt-20 shadow-2xl main-layout border-2 py-10 px-5 rounded-md">
      <div className="text-center mb-4">
        <h1 className="text-xl md:text-2xl font-bold text-gradient">Login to Nextlot</h1>
        <p className=" text-sm dark:text-muted mt-2">Welcome to back! Please sign in to continue</p>
      </div>
      ...
      <p className="text-sm dark:text-muted pt-5 text-center">
        ...
        <Link to={'/signup'} className="text-blue-600 font-bold dark:text-white">
          Sign up
        </Link>{' '}
        Or{' '}
        <Link className="text-blue-600 font-bold dark:text-white" to={'/reset-password'}>
          Reset Password
        </Link>
      </p>
    </div>
